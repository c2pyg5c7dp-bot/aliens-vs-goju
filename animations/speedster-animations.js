// Speedster animation loader for directional sprites (green-tinted Player sprites)
...
(function() {
  ...
  // Speedster animation state manager
  class SpeedsterAnimationController {
    constructor(basePath = './animations/speedster'){
      ...
      for(let i = 0; i < frameCount; i++){
        ...
        img.onload = () => {
          ...
          if(this.loadedCount === this.totalToLoad){
            this.enabled = true;
            console.info('All speedster animations loaded');
          }
        };
    ...
    // Preload all speedster animations
    loadAll(){
      try{
        ...
        console.info('Loading speedster animations...');
      }catch(e){
        console.warn('Speedster animation load failed:', e);
      }
    }
  ...
  window.speedsterAnimController = new SpeedsterAnimationController();
  console.log('✅ Speedster animation controller created');

  // Auto-load animations
  window.speedsterAnimController.loadAll();
  console.info('Speedster animations loading...');
})();
