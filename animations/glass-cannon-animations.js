// Glass Cannon animation loader for directional sprites (purple-tinted Player sprites)
...
(function() {
  ...
  // Glass Cannon animation state manager
  class GlassCannonAnimationController {
    constructor(basePath = './animations/glass_cannon'){
      ...
      for(let i = 0; i < frameCount; i++){
        ...
        img.onload = () => {
          ...
          if(this.loadedCount === this.totalToLoad){
            this.enabled = true;
            console.info('All glass cannon animations loaded');
          }
        };
    ...
    // Preload all glass cannon animations
    loadAll(){
      try{
        ...
        console.info('Loading glass cannon animations...');
      }catch(e){
        console.warn('Glass cannon animation load failed:', e);
      }
    }
  ...
  window.glassCannonAnimController = new GlassCannonAnimationController();
  console.log('✅ Glass Cannon animation controller created');

  // Auto-load animations
  window.glassCannonAnimController.loadAll();
  console.info('Glass Cannon animations loading...');
})();
